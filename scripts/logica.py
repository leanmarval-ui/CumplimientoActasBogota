...
def procesar_todo(df_proyectos, df_intermedia, df_semanal, fechas_mes):
    ...
    # =========================
    col_fecha_intermedia = "fechaFin" if "fechaFin" in df_intermedia.columns else [c for c in df_intermedia.columns if "fecha" in c.lower()][0]
    col_fecha_semanal = "fechaFin" if "fechaFin" in df_semanal.columns else [c for c in df_semanal.columns if "fecha" in c.lower()][0]
